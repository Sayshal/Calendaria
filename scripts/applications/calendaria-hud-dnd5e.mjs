/**
 * Draggable Calendar HUD (D&D 5e Legacy)
 * Extends the D&D 5e CalendarHUD to add drag functionality when available.
 * @deprecated Use CalendariaHUD (system-agnostic) instead. This is kept for dnd5e compatibility.
 * @module Applications/CalendariaHUDDnd5e
 * @author Tyler
 */
...
/**
 * Legacy Calendar HUD with dragging, positioning, and time rotation features.
 * Only functional when running on the dnd5e system.
 * @deprecated Use CalendariaHUD (system-agnostic) instead.
 */
export class CalendariaHUDDnd5e extends BaseClass {
  /** @override */
